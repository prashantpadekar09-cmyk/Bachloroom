      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <header className="sticky top-0 z-30 flex min-h-18 w-full items-center justify-between border-b border-slate-200 bg-white/85 px-4 backdrop-blur-2xl sm:h-20 sm:px-6">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <Link
              to="/"
              className="inline-flex items-center gap-2 rounded-2xl bg-[linear-gradient(135deg,#2b1c12_0%,#8a6431_100%)] px-4 py-2 text-sm font-bold text-[#f8e7bf] shadow-md shadow-amber-900/20 transition hover:scale-105 active:scale-95"
            >
