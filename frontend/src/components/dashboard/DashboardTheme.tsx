  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
      <div className="mb-6 flex items-center justify-end">
        <Link
          to="/"
          className="inline-flex items-center gap-2 rounded-2xl border border-amber-200 bg-[linear-gradient(135deg,#2b1c12_0%,#8a6431_100%)] px-4 py-2.5 text-sm font-bold text-[#f8e7bf] shadow-sm transition hover:scale-105 active:scale-95"
        >
...
export function DashboardSurface({ children, className = "" }: DashboardSurfaceProps) {
  return (
    <section
      className={`rounded-[2rem] border border-amber-100/70 bg-[linear-gradient(180deg,rgba(248,245,235,0.96)_0%,rgba(241,236,226,0.94)_100%)] p-6 shadow-[0_30px_90px_-60px_rgba(36,25,15,0.32)] backdrop-blur-xl sm:p-7 ${className}`.trim()}
    >
      {children}
    </section>
  );
...
export function DashboardStatCard({
  ...
  return (
    <div className="rounded-[1.75rem] border border-amber-100/70 bg-[linear-gradient(180deg,rgba(248,245,235,0.94)_0%,rgba(241,236,226,0.94)_100%)] p-5 shadow-[0_24px_60px_-48px_rgba(36,25,15,0.34)] backdrop-blur-xl">
