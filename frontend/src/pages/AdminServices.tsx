  ...
  return (
    <div className="space-y-8">
      ...
      <AdminPageHero
        ...
        description="Manage service inventory, provider information, and city/category coverage in one premium view."
        badge={`${filteredServices.length} active services`}
      >
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div>
                    <label className="mb-2 block text-sm font-semibold text-gray-700">
                      Service Photo <span className="text-xs font-normal text-gray-400">(PNG / JPG, high resolution)</span>
                    </label>
                    {serviceForm.imageFile && (
                      <div className="mb-3 flex items-center gap-3">
                        <div className="relative h-16 w-16 overflow-hidden rounded-lg border border-gray-200">
                          <img src={serviceForm.imageFile} alt="Current" className="h-full w-full object-cover" loading="lazy" />
                        </div>
                        <button
                          type="button"
                          onClick={() => setServiceForm((prev) => ({ ...prev, imageFile: "" }))}
                    ...
                    <label className="flex min-h-[80px] cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-blue-200 bg-blue-50/50 px-4 py-3 text-center transition hover:border-blue-400 hover:bg-blue-50">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          reader.onloadend = () => setServiceForm((prev) => ({ ...prev, imageFile: reader.result as string }));
