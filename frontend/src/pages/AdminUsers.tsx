...
export default function AdminUsers() {
  ...
  return (
    <div className="space-y-8">
      ...
      <AdminPageHero
        eyebrow="Access & Members"
        title="User Management"
        description="Manage roles, review user status, and moderate identity uploads with a cleaner admin workflow."
        badge={`${filteredUsers.length} members`}
      >
          ...
          <table className="luxury-table">
            <thead>
              <tr>
                ...
                <th className="px-8 py-6 text-xs font-bold text-gray-400 uppercase tracking-widest">Verification Media</th>
              ...
              <AnimatePresence mode="popLayout">
                {filteredUsers.map((user) => (
                  ...
                  >
                    ...
                    <td className="px-8 py-6">
                      {user.idDocument || user.selfieImage ? (
                        <button
                          type="button"
                          onClick={() => setPreviewDocument(user.role === "user" ? user.selfieImage || null : user.idDocument || null)}
                        ...
                        >
                          {user.role === "user" ? "View Selfie" : "View Upload"}
                        </button>
                      ) : (
