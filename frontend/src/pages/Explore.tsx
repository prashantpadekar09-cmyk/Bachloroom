...
export default function Explore() {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#f5eee5_0%,#efe1cf_18%,#fffaf3_42%,#f8f1e7_72%,#ffffff_100%)]">
      {/* Hero Section */}
      <section className="relative flex min-h-[60vh] items-center justify-center overflow-hidden bg-[#16120d]">
        ...
        <div className="relative z-10 max-w-4xl w-full px-4 text-center">
          ...
          <motion.p 
            ...
            className="mx-auto mb-10 max-w-2xl text-xl font-medium text-amber-50/85"
          >
          ...
          <motion.div 
            ...
            className="flex flex-col gap-2 rounded-[1.75rem] border border-amber-200/25 bg-white/10 p-2 shadow-2xl backdrop-blur-xl md:flex-row"
          >
            ...
            <button className="flex items-center justify-center gap-2 rounded-xl bg-[#f4e1bf] px-8 py-4 font-bold text-[#1e140d] shadow-lg shadow-amber-900/10 transition-all hover:brightness-105">
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        {!loading && filteredRooms.length === 0 && (
          <div className="py-20 text-center">
            ...
            <p className="text-[#7a6553]">Try adjusting your search or category filters.</p>
            <button 
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[3rem] bg-[linear-gradient(135deg,#16120d_0%,#2b1c12_34%,#7c5a2c_100%)] p-12 text-center shadow-[0_40px_100px_-50px_rgba(52,34,16,0.85)] md:p-20">
          ...
          <div className="relative z-10">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-xl text-amber-50/80">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/rooms" className="rounded-2xl border border-amber-200/30 bg-white/10 px-10 py-5 text-lg font-bold text-white transition-all hover:bg-white/20">
                Browse All Rooms
              </Link>
            </div>
          </div>
