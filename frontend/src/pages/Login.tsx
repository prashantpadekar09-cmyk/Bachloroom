      ...
      <div className="mx-auto grid max-w-6xl gap-5 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        >
          ...
          <p className="mt-4 max-w-md text-sm leading-7 text-slate-600 sm:text-base">
            Sign in to manage listings, support, saved rooms, and your room search from one place.
          </p>
        ...
        >
          <div className="mx-auto max-w-md">
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#8a6431]">Account access</p>
            ...
            <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="text-center text-sm text-slate-600">
                ...
                <Link to="/register" className="font-semibold text-[#8a6431] hover:text-[#b48845]">
                  Sign up
                </Link>
              </div>
            </form>
