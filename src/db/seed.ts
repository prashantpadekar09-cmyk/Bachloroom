...
const showcaseCleanupStatements = [
  "DELETE FROM payments WHERE roomId IN (SELECT id FROM rooms WHERE id LIKE 'showcase-room-%')",
  ...
  "DELETE FROM bookings WHERE roomId IN (SELECT id FROM rooms WHERE id LIKE 'showcase-room-%')",
  "DELETE FROM reviews WHERE roomId IN (SELECT id FROM rooms WHERE id LIKE 'showcase-room-%') OR id LIKE 'showcase-review-%'",
  "DELETE FROM payouts WHERE ownerId LIKE 'showcase-owner-%'",
