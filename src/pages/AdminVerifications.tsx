                ...
                <AnimatePresence mode="popLayout">
                  {filteredUsers.map((u) => (
                    ...
                    >
                      ...
                      <td className="px-8 py-6">
                        {u.idDocument || u.selfieImage ? (
                          <button
                            type="button"
                            onClick={() => setPreviewDocument(u.role === "user" ? u.selfieImage : u.idDocument)}
                          ...
                          >
                            ...
                            {u.role === "user" ? "View Selfie" : "View ID"}
                          </button>
                        ) : (
                          <span className="text-gray-400 text-xs font-bold italic">No Upload</span>
                        )}
                      </td>
