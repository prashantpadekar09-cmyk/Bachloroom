...
const premiumTestimonials = [
  {
    ...
    rating: 4.9,
    tag: "Student renter",
    detail: "The booking flow felt simple, the room looked exactly like the photos, and moving in was much smoother than I expected.",
  },
  {
    name: "Priya Verma",
    city: "Mumbai",
        ...
        <div className="relative z-10 mx-auto grid min-h-[calc(100vh-84px)] max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1.08fr_0.92fr] lg:px-8 lg:py-12">
          <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="flex flex-col justify-center">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <button type="button" onClick={() => navigate("/register")} className="inline-flex items-center justify-center rounded-2xl border border-white/20 bg-white/10 px-5 py-3 text-sm font-bold text-white backdrop-blur-md transition hover:bg-white/20">Create Account</button>
            </div>
