    ...
    <>
      ...
      <nav className={`fixed inset-x-0 top-0 z-50 border-b backdrop-blur-2xl transition-all duration-200 ${
        ...
        <div className="mx-auto flex min-h-[76px] max-w-7xl items-center justify-between gap-3 px-4 sm:min-h-[84px] sm:gap-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#2563eb_0%,#38bdf8_100%)] text-white shadow-lg shadow-sky-200 sm:h-12 sm:w-12">
              <span className="text-lg font-black">BR</span>
            </div>
            <div className="min-w-0">
              <p className="truncate text-xs font-black uppercase tracking-[0.22em] text-slate-950 sm:text-sm sm:tracking-[0.28em]">
                Bachelor Rooms
              </p>
              <p className="hidden truncate text-xs font-medium text-slate-500 sm:block">
                Search, book, and manage rooms faster
              </p>
            </div>
          </Link>
