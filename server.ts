...
import { initSupabaseMirror, isSupabaseMirrorEnabled, scheduleSupabaseSync } from "./src/db/supabaseMirror.js";
...
async function startServer() {
  ...
  // Prevent SPA HTML fallbacks from breaking API clients expecting JSON.
  app.use("/api", (req, res) => {
